...
class SettingsScreen extends StatelessWidget {
            ...
            _buildSettingsGroup(
              ...
              children: [
                _buildTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(createSlideRoute(
                        const WidgetsScreen(), direction: SlideFrom.right));
                  },
                ),
                _buildTile(
                ...
                _buildTile(
                  ...
                  title: 'How to use?', // Changed title to match target screen better
                  onTap: () {
                    Navigator.of(context).push(createSlideRoute(
                        const TutorialScreen(), direction: SlideFrom.right));
                  },
                ),
              ],
            ),
            ...
            _buildSettingsGroup(
              ...
              children: [
                _buildTile(
                  ...
                  onTap: () => _openWebView(context, 'Terms of Use', 'https://google.com'),
                ),
                _buildTile(
                  iconPath: 'assets/images/st_privacy.png',
                  title: 'Privacy Policy',
                  onTap: () => _openWebView(context, 'Privacy Policy', 'https://google.com'),
                ),
                _buildTile(
                  iconPath: 'assets/images/st_contact.png',
                  title: 'Contact Us',
                  onTap: () => _openWebView(context, 'Contact Us', 'https://google.com'),
                ),
              ],
            ),
  ...
  Widget _buildRemoveAdsBanner(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(createSlideRoute(
            const SalesScreen(), direction: SlideFrom.bottom));
      },
      child: Container(
  ...
  Widget _buildTile({
    ...
    return ListTile(
      ...
      leading: Image.asset(
        ...
        width: 32,
        height: 32,
        errorBuilder: (_,__,___) => const Icon(Icons.settings, color: Colors.grey),
      ),
      title: Text(
        title,
